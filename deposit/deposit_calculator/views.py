...
class DepositCalculator(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            serializer.validated_data['calculated_value'] = self.calculate_deposit(date, amount, rate, periods)
            serializer.save()
            return Response(serializer.validated_data['calculated_value'], status=status.HTTP_200_OK)
